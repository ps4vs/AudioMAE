...
from timm.models.swin_transformer_v2_cr import SwinTransformerV2CrBlock
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward(self, imgs, mask_ratio=0.8):
        ...
        print(f'shape after encoder complete is {emb_enc.shape}, {emb_enc[0, 0:3, 0:3]}')
        ...
        loss_contrastive = torch.FloatTensor([0.0])
